...
// revisamos que no haya errores por parte del usuario
let nombre_jugador = ""
...
if(nombre_jugador.trim().length > 0 && nombre_jugador != null)// el nombre sea los caracteres mayor que cero y diferente de null {{
